...
项目概况
================
在这一项目中，利用一组伪造的短信与电话通信记录，你将会完成五个任务。你将运用 Javascript 分析并回答与数据集中的短信与通话记录相关的问题。

我将会学到什么？
---------------------------
完成项目后，你将可以：

* 设计并编写 Javascript 程序，完成现实任务
* 在计算机上编写 Javascript 程序
* 写出符合 [Airbnb Javascript code style](https://github.com/yuche/javascript) 编码规范的 Javascript 代码，代码具有良好的可读性
* 在 Javascript 中处理字符串和数值数据
* 选择并使用 Javascript 的内置数据结构
* 使用互联网资源来帮助你
* 使用 Javascript 的内置函数，并编写自己的函数
* 使用 Javascript 中的循环和条件语句

为什么建立这样一个项目？
-------------
你将在现实场景中应用你学到的知识。这五个任务将为你提供亲自解决各种编程问题的经验。我们会对你的代码进行审核，通过反馈帮助你提高 Javascript 编程技能。

如何为项目做准备
------
为了完成这个项目，首先应完成第1部分 Javascript 编程介绍的课程。如果你已经有了以上列出的技能，你就可以尝试这个项目，如果你发现你需要更新你的知识，那就返回课程阅读材料。
...
第一步
--------
Clone本代码库，里面会有2 个 CSV 文件 `calls.csv` 和 `texts.csv`。
